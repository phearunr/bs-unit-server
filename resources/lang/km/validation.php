...
return [
    ...
    */
    ...
    'email'                => ':attribute នេះមិនត្រឹមត្រូវ។',
    'exists'               => ':attribute មិនមានក្នុងប្រព័ន្ធ',
    'file'                 => 'The :attribute must be a file.',
    'filled'               => ':attribute ទាមទារឲ្យមាន។',
    'gt'                   => [
    ...
    'min'                  => [
        'numeric' => ':attribute ត្រូវតែមានយ៉ាងតិច :min។',
        'file'    => ':attribute ត្រូវតែមានយ៉ាងតិច :min គីឡូបៃ។',
        'string'  => ':attribute ត្រូវតែមានយ៉ាងតិច :min តួអក្សរ។',
        'array'   => ':attribute ត្រូវតែមានយ៉ាងតិច :min។',
    ],
    ...
    'required'             => ':attribute ទាមទារឲ្យមាន។',
    'required_if'          => ':attribute ទាមទារនៅពេល :other គឺ :value។',
    'required_unless'      => 'The :attribute field is required unless :other is in :values.',
    'required_with'        => ':attribute ទាមទារនៅពេល :values ត្រូវបង្ហាញ។',
    'required_with_all'    => 'The :attribute field is required when :values is present.',
    'required_without'     => ':attribute ទាមទារនៅពេល :values មិនត្រូវជ្រើសរើស។',
    'required_without_all' => ':attribute ត្រូវបានទាមទារពេលគ្មាន :values បានបង្ហាញ។',
    ...
    */
    'attributes' => [
        'unit_id' => 'លេខអចលនទ្រព្យ',
        'hold_day' => 'ចំនួនថ្ងៃព្យួរ',
        'remark' => 'សម្គាស់',
        'unit_hold_request_id' => 'សម្នើរព្យួរ',
        'other_discount_allowance' => 'Other Discount Allowed ($)',
        'deposit_amount' => 'ចំនួនប្រាក់កក់',
        'payment_option_id' => 'ជម្រើសបង់ប្រាក់',
        'loan_duration' => 'រយៈពេលរំលស់គិតជាខែ',
        'interest' => 'អត្រាការប្រាក់ប្រចាំឆ្នាំគិតជា(%)',
        'special_discount' => 'ការបញ្ចុះតម្លៃពិសេសជា(%)',
        'is_first_payment' => 'ការបង់ដំបូង',
        'first_payment_duration' => 'រយៈពេលបង់ប្រាក់ដំបូង',
        'first_payment_percentage' => 'ចំនួនប្រាក់បង់ដំបូងជា(%)',
        'first_payment_amount' => 'ចំនួនប្រាក់បង់ដំបូងជា($)',
        'customer_name' => 'ឈ្មោះអតិថិជនទី១', 
        'customer_gender' => 'ភេទអតិថិជនទី១',
        'customer2_name' => 'ឈ្មោះអតិថិជនទី២',
        'customer2_gender' => 'ភេទអតិថិជនទី២',
        'customer_phone_number' => 'លេខទូរស័ព្ទអតិថិជនខែ្សទី១',
        'customer_phone_number2' => 'លេខទូរស័ព្ទអតិថិជនខែ្សទី២',
        'action_reason' => 'មូលហេតុ',
        'unit_deposit_request_id' => 'សម្នើរកក់ប្រាក់',
        'signed_at' => 'ចុះហត្ថលេខាថ្ងៃទី',
        'start_payment_date' => 'បង់ប្រាក់រាល់ថ្ងៃទី',
        'attachments' => 'ឯកសារភ្ជាប់',
        'deleted_attachments' => 'ឯកសារភ្ជាប់ចាស់',
        'new_attachments' => 'ឯកសារភ្ជាប់ថ្មី',
        'name' => 'ឈ្មោះ',
        'email' => 'អ៊ីមែល',                
        'phone_number' => "លេខទូរស័ព្ទ",
        'gender' => 'ភេទ',
        'birthdate' => 'ថ្ងៃកំណើត',                
        'password' => 'ពាក្យសង្ងាត់',                
        'managed_by' => 'ក្រុមផ្នែកលក់',
        'avatar' => 'រូបភាពប្រូហ្វាល'
    ],
];
