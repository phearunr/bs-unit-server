...
<head>
  ...
  @font-face {
    font-family: 'Khmer';
    font-style: all;
    src: local('Khmer'), url({{ asset('fonts/khmer/khmer.ttf') }}) format('truetype');
  ...
  @font-face {
    font-family: 'Moul';
    font-style: all;   
    src: local('Moul'), url({{ asset('fonts/moul/moul.ttf')  }}) format('truetype');
    unicode-range: U+1780-17FF, U+200C, U+25CC;
  }  
...
@php  
  $customer1 = [
    'name' => $contract_request->customer1_name,
    'gender' => $contract_request->customer1_gender == 1 ? "ប្រុស" : "ស្រី",
    'birth_day' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer1_birthdate->day),
    'birth_month' =>  \App\Helpers\KhmerMonth::convertToKhmerMonth($contract_request->customer1_birthdate->month),
    "birth_year" => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer1_birthdate->year),
    "nid_number" => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer1_nid),
    'nid_issued_day' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer1_nid_issued_date->day),
    'nid_issued_month' => \App\Helpers\KhmerMonth::convertToKhmerMonth($contract_request->customer1_nid_issued_date->month),
    'nid_issued_year' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer1_nid_issued_date->year)
  ];

  if ( $contract_request->customer2_name != "" ) {
    $customer2 = [
      'name' => $contract_request->customer2_name,
      'gender' => $contract_request->customer2_gender == 1 ? "ប្រុស" : "ស្រី",
      'birth_day' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer2_birthdate->day),
      'birth_month' =>  \App\Helpers\KhmerMonth::convertToKhmerMonth($contract_request->customer2_birthdate->month),
      "birth_year" => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer2_birthdate->year),
      "nid_number" => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer2_nid),
      'nid_issued_day' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer2_nid_issued_date->day),
      'nid_issued_month' => \App\Helpers\KhmerMonth::convertToKhmerMonth($contract_request->customer2_nid_issued_date->month),
      'nid_issued_year' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->customer2_nid_issued_date->year)
    ];
  }

  $address = [
    'house_no' => $contract_request->customer_house_no,
    'street' => $contract_request->customer_street,
    'phum' => $contract_request->customer_phum,
    'sangkat' => $contract_request->customer_commune,
    'khan' => $contract_request->customer_district,
    'city' =>$contract_request->customer_city
  ];

  if ( is_null($contract_request->customer_phone_number2) || $contract_request->customer_phone_number2 == "" ) {
    $phone_number = $contract_request->customer_phone_number;
  } else {
    $phone_number = $contract_request->customer_phone_number.' / '.$contract_request->customer_phone_number2;
  } 

  $unit = [
    'house_no' => $contract_request->unit_code,
    'street' => $contract_request->unit_street,
    'price' => \App\Helpers\NumberFormat::convertToKhmerNumber(number_format($contract_request->unit_sold_price)),
    'price_khmer_word' => App\Helpers\NumberFormat::covertUsdToKhmerWord($contract_request->unit_sold_price),
    'type' => "ផ្ទះល្វែង",
    'land_width' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->unit_land_width),
    'land_length' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->unit_land_length),
    'house_width' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->unit_house_width),
    'house_length' => \App\Helpers\NumberFormat::convertToKhmerNumber($contract_request->unit_house_length)
  ];
