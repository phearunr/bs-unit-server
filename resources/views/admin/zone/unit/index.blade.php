    ...
    <div class="row">
        ...
        <div class="col-lg-8 ">
            <ul class="yk-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.zones.site_engineers.index', ['zone_id' => $zone->id]) }}">Site Engineers</a>
                </li>
            </ul>
                ...
                @else
                    ...
                    <div class="border w-100 bg-white my-3 shadow-sm">
                        <div class="d-flex pl-3 py-2">
                            ...
                            <div class="align-self-center p-2 d-none d-sm-block">
                                <span class="d-block text-muted text-right">Price</span>
                        ...
                        <div class="d-flex bg-light">
                            <div class="d-flex p-2 flex-column flex-fill justify-content-center align-items-center border">
