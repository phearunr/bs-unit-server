...
@section('content')
<div class="container">
    <form method="POST" action="{{ route('admin.projects.destroy', [ 'id' => $project->id ]) }}" novalidate="novalidate" autocomplete="false">
    @csrf        
    {{ method_field("DELETE") }}
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __("Delete") }} {{__("Project")}} : <strong>{{ $project->name }}</strong></div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <p class="mb-0">Are you sure want to delete the project : <strong>{{ $project->name }}</strong>?</p>
