...
<div class="container">
    <div class="row justify-content-center"> 
        <div class="col-lg-3">
            <form method="GET" action="{{ route('admin.projects.index') }}" name="user-search-from" novalidate="novalidate" autocomplete="false" class="position-sticky sticky-top-offset-1">
            <div class="card mb-3">         
