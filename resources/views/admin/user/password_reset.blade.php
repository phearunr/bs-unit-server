        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.user.password.reset', ['id'=>$user->id]) }}" novalidate="novalidate" autocomplete="false">
                        @csrf
                        ...
                        <p class="text-info">**Reset user's password will remove all login session in mobile app.</p>
                        <div class="row">
                            <div class="col">
