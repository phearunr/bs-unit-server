...
<div class="container">         
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">                    
                    ...
                    @endif 
                    <form method="POST" action="{{ route('admin.site_engineers.personal_information.update', [ 'id' => $user->id ]) }}" enctype="multipart/form-data" novalidate="novalidate" autocomplete="false" id="UpdatePersonalInformationForm">    
                        @csrf
                        @method('PUT')
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-body">
                    <a href="{{ route('admin.site_engineers.password.show', [ 'id' => $user->id ]) }}" class="btn btn-danger btn-sm">Reset Password</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-body"> 
                    ...
                    @endif
                    <form method="POST" action="{{ route('admin.site_engineers.account_setting.update', [ 'id' => $user->id ]) }}" id="UpdateAccountSettingForm" novalidate="novalidate" autocomplete="false">
                        @csrf
                        @method('PUT')
        ...
        <div class="col-md-12">
            <div class="card mb-2">
                <div class="card-body" style="max-height: 350px; overflow: auto;">
                    ...
                    @endif
                    <form method="POST" action="{{ route('admin.site_engineers.managed_zones.update', [ 'user' => $user->id ]) }}" id="UpdateZoneForm" novalidate="novalidate" autocomplete="false">        
                    @csrf
                    @method('PUT')  
