<a href="{{ route('admin.unit_deposit_requests.show', [ 'id' => $notification->data['id'], 'read' => $notification->id ]) }}"
	...
	<div class="w-100 align-self-start">    
		<p class="mb-0 pb-0">{!! __('unit_deposit_request.notification.pending', [
			'name' => $notification->data['additional_data']['user_name'],
			'unit_code' => 	$notification->data['additional_data']['unit_code']
		]) !!}</p>
