...
@section('content')
<div class="container">
    <form method="POST" action="{{ route('admin.payment_options.store') }}" novalidate="novalidate" autocomplete="false">
    @csrf        
            ...
            <div class="col-md-8">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="first_payment_checkbox" name="is_first_payment" data-toggle="collapse" href="#first_payment_container" {{ old('is_first_payment') == 'one' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="first_payment_checkbox">First Payment Plan</label>
                                </div>
                            </div>
                        </div>
                        <div class="row collapse {{ old('is_first_payment') ? 'show' : 'closed'}}" id="first_payment_container">
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="first_payment_duration" id="first_payment_duration" 
                                           placeholder="0" min="0"
                                           value="{{ old('first_payment_duration') }}">
                            ...
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="first_payment_percentage" id="first_payment_percentage" 
                                           ...
                                           value="{{ old('first_payment_percentage') }}">
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col">
                                <button type="submit" class="btn btn-primary">{{__("Create New")}} {{ __("Payment Option") }}</button>
                            </div>
                            <div class="col">
