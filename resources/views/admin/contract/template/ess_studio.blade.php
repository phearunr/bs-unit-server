...
<body>
  ...
  <h4 class="main-title text-center">ឧបសម្ព័ន្ធ៣ : (Studio Room)</h4>
  <p class="text-lg text-center mb-4">សម្ភារៈដែលបូកបញ្ចូលក្នុងបន្ទប់ខុនដូប្រភេទ១បន្ទប់រួម</p>
  ...
  <p class="second-indent">- ម៉ាស៊ីនទឹកក្តៅទឹកត្រជាក់០១។</p>
  <div style="page-break-after: always;"></div>
