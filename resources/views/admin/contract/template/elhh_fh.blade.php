...
<body>
  ...
  <ul class="ml-0 pl-0" style="{{ isset($customer2) ? '' : 'page-break-after: always;' }}">
    ...
    <li>ឧបសម្ព័ន្ធ៥ : លិខិតប្រគល់សិទ្ធឈរតំណាងក្រុមហ៊ុន</li>
  	...
  	<p class="mb-0">ផ្ទះល្វែងប្រភេទ EFH មានទំហំដូចខាងក្រោម៖</p>
  ...
  <p>ដែល​មាន​បន្ទប់​ទទួល​ភ្ញៀវ​ចំនួន០១ ផ្ទះបាយ០១ បន្ទប់គេង០២ និងបន្ទប់ទឹក០៣ (តាម​ប្លង់​បាត​ដែរ​ភ្ជាប់​ជូន)។</p>

  <p class="mb-0"><span class="text-bold"><u>ប្រការ២:</u></span> ភាគី “ខ” កាលបរិច្ឆេទនៃការទូទាត់ប្រាក់</p>
  <p class="pl-5">២.១ ភាគី “ខ” ត្រូវ​ទូ​ទាត់​ប្រាក់​សរុប​ថ្លៃ​ទិញ​ផ្ទះ​តាម​ដំណាក់​កាល​ជា​បន្ត​បន្ទាប់​ដូច​មាន 
  ចែង​ក្នុង​តារាង​ទូ​ទាត់​ប្រាក់​ក្នុង​ឧបសម្ព័ន្ធ១។</p>
  <p class="pl-5">២.២ ក្នុង​ករណី​ដែល​ភាគី “ខ” យឺត​យ៉ាវ ឬ​ខក​ខាន​មិន​បាន​បង់​ប្រាក់​តាម​កាល​កំណត់​ក្នុង ឧបសម្ព័ន្ធ១ នោះ​ទេ​ភាគី “ខ” ត្រូវ​បង់​ប្រាក់​ពិន័យ​ក្នុង​អត្រា 1.2% (មួយ​ក្បៀស​ពីរ​ភាគរយ) នៃ​ទឹក​ប្រាក់​ត្រូវ​បង់​ក្នុង១ខែ។ ករណី​ការ​យឺត​យ៉ាវ​ និង​ខក​ខាន​លើស​ពី៣ខែ​នោះ​ចាត់​ទុក​ថា​ភា​គី “ខ” បាន​បោះ​បង់​ចោល​ការ​ទិញ​ផ្ទះ​នេះ​ជា​ឯក​តោ​ភាគី។ ក្នុង​ករណី​នេះ​ភាគី “ក” មាន​សិទ្ធិ​លក់​ផ្ទះ​ឲ្យ​ទៅ​អ្នក​ផ្សេង​ទៀត​បាន​ហើយ​ប្រាក់​ដែលបាន​បង់​នៃ​ដំណាក់​កាល​នីមួយៗ​ចាត់​ទុក​ជា​អ​សារ​បង់។</p>

  <p><span class="text-bold"><u>ប្រការ៣:</u></span> ភាគី “ក” សន្យា​ប្រគល់​ផ្ទះ​នៅ​ក្នុង​អំឡុង​ពេល​២៤ខែ​ និង​អនុ​គ្រោះ​៨​ខែ​បន្ដ​បន្ទាប់​ពី​ថ្ងៃចុះ​កិច្ច​សន្យា​នឹង​ប្រគល់​ផ្ទះលេខ {{ $unit['house_no'] }} ជូន​ទៅ​ភាគី “ខ”។ ករណី​ការ​សន្យា​មិន រួច​រាល់​តាម​ការ​កំណត់​ភាគី “ក” សន្យា​និង​សង​សំណង​ជូន​ភាគី “ខ”​ គុណ​នឹង​មួយ​ភាគរយ​នៃ​ទឹក​ប្រាក់​សរុប​ដែរ​ភាគី “ខ” បាន​បង់​ចូល​ក្រុមហ៊ុន​ជាក់​ស្ដែង។</p>
  ...
  <p><span class="text-bold"><u>ប្រការ៥:</u></span> ភាគី “ក” មាន​កាតព្វ​កិច្ច​ក្នុង​ការ​ថែ​រក្សា​នូវ​សុវត្ថិភាព សន្តិសុខ សណ្តាប់ធ្នាប់ សោភ័ណ្ឌភាព ទ្រព្យ​សម្បត្តិ​សាធារណៈ​ផ្សេងៗ​ក្នុង Borey East Land & Home ទាំង​មូល។ បន្ទាប់​ពី​ភាគី “ក” ប្រគល់​ផ្ទះ​ជូន​ទៅ​ភាគី “ខ” រួច​ភាគី “ខ” មាន​កាតព្វ​កិច្ច​បង់​ថ្លៃ សេវា​ចំនួន​ 240USD (ពីរ​រយ​សែ​សិប​ដុល្លា​អាមេរិក) ក្នុង១ឆ្នាំ​លើ​ផ្នែក​សេវា​ដែល​មាន​ដូច​ជា​អនាម័យ​សាធារណៈ ភ្លើង​បំភ្លឺ​ផ្លូវ និង​សន្តិ​សុខ ២៤ ម៉ោង។ ភាគី “ក” មាន សិទ្ធិ​ក្នុងការ​កែ​ប្រែ​តម្លៃ​ខាង​លើទៅ​តាម​តម្លៃ​ទី​ផ្សារ​ប្រសិន​បើ​មាន​ការ​កែ​ប្រែ​ភា​គី “ក” នឹង​ជូន​ដំណឹងជា សា​ធារណៈ​រយៈ​ពេល​១ខែ​ទុក​ជា​មុន​។</p>
  ...
  <p class="second-indent">- ធ្នើចង្ក្រានរៀបការ៉ូ ចំនួន ០១។</p>
  <p class="second-indent">- ស៊ីងលាងចាន ចំនួន ០១។</p>  
  ...
  <p class="second-indent">- ទឹកផ្កាឈូក។</p> 
  <div style="page-break-after: always;"></div>
