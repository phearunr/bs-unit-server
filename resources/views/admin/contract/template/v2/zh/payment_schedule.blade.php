...
<h4 class="zh text-center text-bold">附件1：</h4>
<h4 class="khmer-title text-center">“តារាងកាលវិភាគនៃការទូទាត់ប្រាក់ថ្លៃលក់ទិញអចលនវត្ថុ”</h4>
<h4 class="zh text-center text-bold">“房地产买卖价格支付时间表”</h4>
...
<p class="english text-center font-italic">(根据“买方”的需求，在卖方同意的情况下，可以通过创建新的房地产买卖计划并消除过去被房地产取代的时间来随时更改价格。采购合同所附新合同的附件为附件1)</p>
<div class="row my-2">
  <div class="col">
