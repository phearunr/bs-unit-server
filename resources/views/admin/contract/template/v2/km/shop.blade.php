...
<h3 class="khmer-title text-center mt-3 mb-3">កិច្ចសន្យាលក់ ទិញ តូប</h3>
@endsection

@section('project_suffix')
<span class="text-bold">“អគារសហកម្មសិទ្ធិ”</span>
@endsection
...
<table class="table table-p-1 table-contract-bordered">
    <tr>
    	...
    	<td width="100px" class="text-bold">ចំណែកឯកជនលេខ</td>
    	<td width="30px" class="text-center">៖</td>
    	<td width="250px" class="english text-bold">{{ isset($is_template) ? '_______________' : $unit->code }}</td>
    </tr>
    <tr>
    	<td width="180px" class="text-bold">ជាន់ទី</td>
    	<td width="30px" class="text-center">៖</td>      
    	<td>
    		<p>
    	...
    	<td width="100px" class="text-bold">
            <p class="mb-0 pb-0">ទំហំសំណង់</p>
            <small><i>(ជាទំហំក្រឡាផ្ទៃចំណែកឯកជន និង ទំហំក្រឡាផ្ទៃប្រើប្រាស់រួម)</i></small>
        </td>
    	<td width="30px" class="text-center">៖</td>
    	<td width="250px">
    		<p class="pb-0">
    		@if( isset($is_template) )
    			_______________
    		@else
    			{{ $unit->building_area }} ម៉្រែតការ៉េ
    		@endif
    		</p>
    		<small><i>ដែល​អាច​មាន​ការ​ប្រែប្រួល​ជា​លក្ខណៈ​បច្ចេកទេស​ត្រឹម ៣ម៉ែត្រក្រឡា លើស ឬ ខ្វះ អាស្រ័យ​លើ​ការ​កំណត់​ព្រុំ​របស់​មន្ត្រី​សុរិយោដី ហើយ​គូភាគី​នឹង​មិន​តវ៉ា​ទាមទារ​សំណង​ពីគ្នា​ឡើយ)។</i></small>
    	</td>
    </tr>
    <tr>
    ...
    <tr>
    	...
    	<td width="30px" class="text-center">៖</td>      
    	<td colspan="4">
    		<p>{{ $contract->management_service_kh }}</p>
    	</td>
    </tr>
    <tr>
    ...
    <tr>
    	...
    	<td class="text-bold" colspan="4">
            ...
            <small><i>តម្លៃ​នេះ ជា​តម្លៃ​ដែល​មាន​ការ​តុប​តែង​រួម​បញ្ជូល​ទាំង​សម្ភារៈ​ប្រើប្រាស់​ដូច​មាន​ចែង​ក្នុង​ឧបសម្ព័ន្ធ៣។ ក្នុង​ករណី​ដែល រោង​ចក្រ​ដែល​អ្នក​ផ្គត់ផ្គង់​សម្ភារៈ​ឈប់​ផលិត​នូវ​ផលិតផលដែល ភាគី ”អ្នកលក់” បានជ្រើសរើស ភាគី អ្នកលក់” សូម​រក្សា​សិទ្ធិ​ក្នុង​ការ​ផ្លាស់ប្តូរ​បំពាក់​នូវ​សម្ភារៈ​ផ្សេង​ជំនួស​វិញ​ដោយ​រក្សា​នូវ​គុណភាព​ដដែល។</i></small>
    	</td>    	
    </tr>
</table>

<p><span class="text-bold">១.៣.</span> ភាគី <span class="text-bold">“អ្នកទិញ”</span> យល់​ព្រម​ទទួល​យក​ទាំង​ស្រុង​នូវ​ប្លង់​រចនា​ម៉ូដ​សំណង់ ព្រម​ទាំង​សន្យា​ថា​មិន​កែប្រែ​រចនាបទ ឬទ្រង់ទ្រាយ ឬគ្រោង​សំណង់​ខាងក្នុង និង​ខាង​ក្រៅ​អចលនវត្ថុ​ដោយ​ខ្លួនឯង ឬ​តាម​រយៈ​ការ​ជួល​បុគ្គល​ដទៃ​មក​ធ្វើការ​កែប្រែ​រចនាបទ ឬទ្រង់ទ្រាយ ឬ​គ្រោង​សំណង់​នៃ​អចលនវត្ថុ​នោះ​ទេ។ ប្រសិន​បើ​មាន​ការ​ចាំបាច់ ភាគី <span class="text-bold">“អ្នកទិញ”</span> អាច​ដាក់​លិខិត​ស្នើ​សុំ​មក​ភាគី <span class="text-bold">“អ្នកលក់”</span> ដោយ​មាន​បញ្ជាក់​ពី​មូលហេតុ​អោយ​បាន​ត្រឹមត្រូវ ច្បាស់លាស់ និងសមរម្យ។ ក្នុង​ករណី​ដែល​ភាគី <span class="text-bold">“អ្នកលក់”</span> ពិចារណា​ហើយ​អនុញ្ញាត និង​យល់​ព្រម​តាម​ការ​ស្នើ​សុំ​នោះ ភាគី <span class="text-bold">“អ្នកលក់”</span> គឺ​ជា​អ្នក​កំណត់ និង​ជ្រើសរើស​បុគ្គល​ណាមួយ ដែល​ខ្លួន​គិត​ថា​មាន​លក្ខណៈ​សម្បត្តិ​គ្រប់គ្រាន់​ក្នុង​ការ​ទទួល​យក​ការងារ​នេះ ដោយ​ការ​ចំណាយ​ទាំងអស់​ជា​បន្ទុក​របស់​ភាគី <span class="text-bold">“អ្នកទិញ”</span> ដែល​បាន​ស្នើសុំ។</p>
<div style="page-break-before: always;"></div>
<p class="khmer-title pb-0 mb-0">ប្រការ២៖ ការទូទាត់ប្រាក់ថ្លៃលក់ទិញអចលនវត្ថុ</p>
<p><span class="text-bold">២.១.</span> ដោយ​មាន​ការ​ព្រមព្រៀង​គ្នា​ក្នុង​ការ​លក់​ទិញ នូវ​អចលនវត្ថុ​ដូច​បាន​ចែង​ក្នុង​ប្រការ១ <span class="text-bold">“អត្តសញ្ញាណ​នៃ​អចលនវត្ថុ​លក់​ទិញ និងតម្លៃ​លក់​ទិញ”</span> ខាងលើ ភាគី <span class="text-bold">“អ្នកទិញ”</span> ត្រូវ​ទូទាត់​ប្រាក់​ថ្លៃ​លក់​ទិញ​អចលនវត្ថុ​ខាង​លើ​ទៅ​តាម​ដំណាក់កាល​នៃ​ការ​ទូទាត់​ឲ្យ​បាន​ត្រឹមត្រូវ គ្រប់​ចំនួន​ និង​ទាន់​ពេល​វេលា​ជា​បន្ត​បន្ទាប់​ដូច​បាន​ចែង​ក្នុង​ឧបសម្ព័ន្ធទី១ <span class="text-bold">“តារាងកាលវិភាគ​នៃ​ការ​ទូទាត់​ប្រាក់​ថ្លៃ​លក់​ទិញ​អចលនវត្ថុ”</span>។ ភាគី <span class="text-bold">“អ្នកទិញ”</span> អាច​ទូទាត់​ប្រាក់​ថ្លៃ​លក់​ទិញ​អចលនវត្ថុ​ដោយ​ផ្ទាល់​នៅ​ការិយាល័យ​របស់​ភាគី <span class="text-bold">“អ្នកលក់”</span> ឬ​តាម​រយៈ​គណនី​ធនាគារ <span class="text-bold">{{ $bank->short_name }}</span> ដូច​មាន​ព័ត៌មាន​លម្អិត​ខាង​ក្រោមនេះ៖</p>
...
<p><span class="text-bold">២.២.</span> ភាគី <span class="text-bold">“អ្នកលក់”</span> អនុគ្រោះ​ជូនភាគី <span class="text-bold">“អ្នកទិញ”</span> ក្នុង​ការ​យឺតយ៉ាវ ឬ​ខក​ខាន​ទូទាត់​ប្រាក់ថ្លៃ​លក់ទិញ​អចលនវត្ថុ​ត្រឹមរយៈពេល <span class="text-bold">០៧ (ប្រាំពីរ) ថ្ងៃប្រតិទិន</span> ដោយ​មិន​បង់​ប្រាក់​ពិន័យ។ ផុត​ពី​រយៈ​ពេល​អនុគ្រោះ​នេះ ក្នុង​ករណី​ដែល​ភាគី <span class="text-bold">“អ្នកទិញ”</span> យឺតយ៉ាវ ឬ​ខកខាន​មិន​បាន​បំពេញ​កាតព្វកិច្ច​ទូទាត់​បង់ប្រាក់​ថ្លៃ​លក់​ទិញ​អចលនវត្ថុ​ជូន​ភាគី <span class="text-bold">“អ្នកលក់”</span> ទៅ​តាម​ដំណាក់​កាល​នៃ​ការ​ទូទាត់​ឲ្យ​បាន​ត្រឹមត្រូវ គ្រប់ចំនួន និង​ទាន់​ពេល​វេលា​ទេ​នោះ ភាគី <span class="text-bold">“អ្នកទិញ”</span> ត្រូវ​បង់​ប្រាក់​ពិន័យ​លើ​ការ​យឺតយ៉ាវ ឬ​ខក​ខាន​នោះ​ក្នុង​មួយថ្ងៃ <span class="text-bold">០៥ (ប្រាំ) ដុល្លារ​អាមេរិក</span>។ ក្នុង​ករណី​ដែល​ការ​យឺតយ៉ាវ ឬ​ខក​ខាន​ក្នុង​ការ​ទូទាត់​ប្រាក់​ថ្លៃ​លក់​ទិញ​អចលនវត្ថុ​នោះ​នៅ​តែ​បន្ត​លើសពី រយៈពេល <span class="text-bold">០៣ (បី) ខែ</span>​ជាប់ៗ​គ្នា ឬ​ក្នុង​ចន្លោះ​រយៈ​ពេល​ណា​មួយ​ដែល​ផល​បូក​នៃ​រយៈ​ពេល​ទាំង​នោះ​លើស​ពី <span class="text-bold">០៣ (បី) ខែ</span> នោះ​ត្រូវ​បាន​សន្មត់ទុក​ជា​មុន និង​ចាត់​ទុក​ថា ភាគី <span class="text-bold">“អ្នកទិញ”</span> រំលាយ​កិច្ចសន្យា​ដោយ​ឯកតោ​ភាគី ដោយ​បោះបង់​ចោល​នូវ​សិទ្ធិ​ទាំង​ឡាយ​ដែល​មាន​លើអចលនវត្ថុ ការ​លក់​ទិញ​អចលនវត្ថុ និង​ចំនួន​ទឹក​ប្រាក់​ដែល​ខ្លួន​បាន​ទូទាត់​មក​ឲ្យ​ភាគី <span class="text-bold">“អ្នកលក់”</span>។ ក្នុង​ករណី​នេះទឹក​ប្រាក់​ដែល​បាន​ទូទាត់​ហើយ​ទាំងអស់​ត្រូវ​ក្លាយ​ជា​ប្រយោជន៍​សម្រាប់​ភាគី <span class="text-bold">“អ្នកលក់”</span> ហើយ ភាគី <span class="text-bold">“អ្នកលក់”</span> មាន​សិទ្ធិ​ពេញ​លេញ​ដោយ​ស្រប​ច្បាប់​ក្នុង​ការ​លក់​អចលនវត្ថុ​ខាង​លើ​ឲ្យ​ទៅ​អតិថិជន ឬ​អ្នក​ទិញ​ផ្សេង​ទៀត​បាន ដោយ​ភាគី <span class="text-bold">“អ្នកទិញ”</span> សន្យា​ថា​នឹង​មិន​តវ៉ា ឬ​ជំទាស់​ឡើយ។ ក្នុង​ករណី​នេះ ប្រសិន​បើ ភាគី <span class="text-bold">“អ្នកទិញ”</span> បាន​ទទួល​យក​អចលនវត្ថុ​ពី ភាគី <span class="text-bold">“អ្នកលក់”</span> ហើយនោះ ភាគី <span class="text-bold">“អ្នកលក់”</span> ទុក​រយៈ​ពេល​ឲ្យ ភាគី <span class="text-bold">“អ្នកទិញ”</span> ដែល​បោះបង់​សិទ្ធិ​លើ​ការ​លក់​ទិញ និង​អចលនវត្ថុ​នោះ <span class="text-bold">០១ (មួយ) ខែ</span> សម្រាប់​រើចេញ​ពី​អចលនវត្ថុ។</p>
