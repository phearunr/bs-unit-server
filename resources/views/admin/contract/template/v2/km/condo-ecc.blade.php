...
<h3 class="khmer-title text-center mt-3 mb-3">កិច្ចសន្យាលក់ ទិញ ខុនដូ ECC</h3>
@endsection
...
<table class="table table-p-1 table-contract-bordered">
    ...
    <tr>
        ...
        @if( isset($is_template) )
            ...
            <small class="text-muted"><i>(ជាទំហំក្រឡាផ្ទៃចំណែកឯកជន)</i></small>
            <p class="pb-0">
            _______________
            </p>    
            <small class="text-muted"><i>(ជាទំហំក្រឡាផ្ទៃប្រើប្រាស់រួម)</i></small>
        @else
            <p class="pb-0">
            {{ $unit->building_area ?? 'N/A' }} ម៉ែត្រការ៉េ
            </p>    
            <small class="text-muted"><i>(ជាទំហំក្រឡាផ្ទៃចំណែកឯកជន)</i></small>
            <p class="pb-0">
            {{ $unit->gross_area ?? 'N/A' }} ម៉ែត្រការ៉េ
            </p>    
            <small class="text-muted"><i>(ជាទំហំក្រឡាផ្ទៃប្រើប្រាស់រួម)</i></small>
         @endif
    	</td>
    ...
    <tr>
        <td width="180px" class="text-bold">ករណី​ទំហំ​ក្រឡាផ្ទៃ​ចំណែក​ឯកជន អាច​មាន​ការ​ប្រែប្រួល</td>
        <td width="30px" class="text-center">៖</td>      
        <td colspan="4">
        ជា​លក្ខណៈ​បច្ចេកទេស​ត្រឹម ៣ម៉ែត្រក្រឡា លើស ឬ ខ្វះ អាស្រ័យ​លើ​ការ​កំណត់​ព្រុំ​របស់​មន្ត្រី​សុរិយោដី ហើយ​គូភាគី​នឹង​មិន​តវ៉ា​ទាមទារ​សំណង​ពី​គ្នា​ឡើយ។
        </td>
    </tr>

    <tr>
        <td width="180px" class="text-bold">ចំណតយានយន្ត</td>
        <td width="30px" class="text-center">៖</td>      
        <td colspan="4">
        ទីតាំង​សម្រាប់​ចំណត​យានយន្ត​នៅ​ក្នុង​បរិវេណអគារ គឺ​ជា​កម្មសិទ្ធិ​របស់​ភាគី “អ្នកលក់” ដោយ​មិន​គិត​បញ្ចូល​ជា​អចលនទ្រព្យ​រួម​ឡើយ។ ភាគី “អ្នកលក់”  ឬ​តំណាង​របស់​ខ្លួន​មាន​សិទ្ធិ​គ្រប់គ្រង​យានយន្ត​ក្នុង​បរិវេណ​អគារ។ ចំណែក​ភាគី ”អ្នកទិញ” អាច​ប្រើប្រាស់​ចំនត​យានយន្ត​បាន​តាម​រយៈ​ការ​បង់​ថ្លៃ​ដែល​កំណត់​ដោយ​ក្រុមហ៊ុន​គ្រប់គ្រង។
        </td>
    </tr>
