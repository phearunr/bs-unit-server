...
<body>
  ...
  <p class="second-indent text-left">- ទូចង្ក្រានលើក្រោម។</p>
  <p class="second-indent text-left">- ចង្ក្រានទំនើប០១ឈុត។</p>
  <p class="second-indent text-left">- ស៊ីងលាងចាន០១។</p>
  <p class="second-indent text-left">- ម៉ាស៊ីនបឺតផ្សែង០១។</p>
  <p class="text-lg text-bold">២. សម្ភារៈក្នុងបន្ទប់ទឹកមានដូចជា</p>
  <p class="second-indent text-left">២.១ បន្ទប់ជាន់ផ្ទាល់ដីរួមមាន</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- បង្គន់</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- ឡាបូ1</p>
  <p class="second-indent text-left">២.២ បន្ទប់ទឹកជាន់ទី1(បន្ទប់ធម្មតា)រួមមាន</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- បង្គន់</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- ឡាបូ០១</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- ផ្កាឈូក០១</p>
  <p class="second-indent text-left">២.៣ បន្ទប់ទឹក (មេគ្រួសារ)រួមមាន</p> 
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- បង្គន់</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- ឡាបូ០១</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- ផ្កាឈូក០១</p>
  <p class="second-indent text-left">&nbsp;&nbsp;&nbsp;&nbsp;- ម៉ាស៊ីនទឹកក្តៅ ទឹកត្រជាក់</p>
  <div style="page-break-after: always;"></div>
