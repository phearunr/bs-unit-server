...
<body>
  ...
  <p>ភាគី “ក” យល់​ព្រម​លក់ ហើយ​ភាគី “ខ” យល់​ព្រម​ទិញ​ផ្ទះ​ប្រភេទ L2 មួយ​ខ្នង ដែល​​មាន​​អា​ស័យ​ដ្ឋាន​​ផ្ទះ​លេខ {{ $unit['house_no'] }} ផ្លូវ {{ $unit['street'] }} ក្នុងតម្លៃ <span class="english-font">USD </span> {{ $unit['price'] }} ({{$unit['price_khmer_word']}}) នៅ​ក្នុង​ បុរី​ចតុមុខ​ស៊ីធី​១  ដែល​មាន​ទី​តាំង​នៅ​ភូមិ​ស្វាយ​ជ្រុំ ឃុំ​ស្វាយ​ជ្រុំ ស្រុក​ខ្សាច់​កណ្តាល ខេត្ត​កណ្តាល។ តម្លៃ​នេះ​ជា​តម្លៃ​ដែល​មាន​បំពាក់​សម្ភារៈ​ប្រើ​ប្រាស់​ដូច​មាន​ក្នុង​ឧបសម្ព័ន្ធ៣។ ផ្ទះ​វីឡា​ប្រភេទ L2 មាន​ទំហំ​ដី​ {{ $unit['land_width'] }} ម៉ែត្រ x {{ $unit['land_length'] }} ម៉ែត្រ ទំហំផ្ទះ {{ $unit['house_width'] }} ម៉ែត្រ x {{ $unit['house_length'] }} ម៉ែត្រ ដែល​មាន​បន្ទប់​ទទួល​ភ្ញៀវ១ ផ្ទះបាយ១ បន្ទប់គេង៥ និងបន្ទប់ទឹក៥ ។</p>
