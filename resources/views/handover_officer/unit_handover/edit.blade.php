...
@section('content')
<div class="container">
    <form method="POST" action="{{ route('handover_officer.unit_handovers.update',['id'=>$handover->id]) }}" novalidate="novalidate" autocomplete="false" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('handover_officer.unit_handovers.send_approval', ['id' =>$handover->id]) }}" id="send-approval-form">
                        @csrf
