    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <ul class="yk-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('site_engineer.zones.site_engineers.index', [ 'zone_id' => $zone->id])}}">Site Engineers</a>
                </li>
            </ul>
                            ...
                            <div class="justify-content-end align-self-center px-3">
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{ route('site_engineer.zones.unit_constructions.show', [ 'zone_id' => $zone->id, 'unit_id' => $unit->id]) }}" class="dropdown-item">
