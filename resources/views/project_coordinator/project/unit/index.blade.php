        ...
        <div class="col-lg-9">
            ...
            <div class="d-flex border unit-container w-100 bg-white my-2 shadow-sm">
                <div class="align-self-center w-100 px-3 py-2">
                    <h5 class="mb-0 font-weight-bold"><a href="{{ route('project_coordinator.projects.units.show', [ 'project_id' => $unit->unitType->project->id, 'unit_id' => $unit->id]) }}">{{ $unit->code }}</a></h5>
