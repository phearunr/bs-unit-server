...
@section('content')
<div class="container">
    <form method="POST" action="{{ route('site_manager.unit_handovers.import') }}" novalidate="novalidate" autocomplete="false" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{ route('site_manager.unit_handovers.import_template') }}" class="btn btn-success">Template File</a>
                            </div>
                            <div class="col">
                                <a href="{{ route('site_manager.projects.index') }}" class="btn btn-secondary float-right">{{ __("Back to") }} {{ __("Unit") }} {{ __("List") }}</a>
                            </div>
                        </div>
                    </div>
                </div>
