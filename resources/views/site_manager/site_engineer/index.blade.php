...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form method="GET" action="{{ route('site_manager.site_engineers.index') }}" name="user-search-from" novalidate="novalidate" autocomplete="false">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            Site Engineer List : <a href="{{route('site_manager.site_engineers.create')}}" class="btn btn-primary btn-sm ">Create New Site Engineer</a>
                        </div>
                ...
                <div class="card-sub-header card-bg-grey collapse {{ Request::query() ? 'show' : '' }}" id="sub-header-collapse">
                    <div class="sub-header-box-wrapper">
                        <div class="form-row">
                            ...
                            <a href="{{ route('site_manager.site_engineers.index') }}" class="btn btn-secondary btn-sm ml-md-2">Clear Filter</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover table-action mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action-td">
                                    <a href="{{ route('site_manager.site_engineers.show',['id'=>$user->id]) }}" class="title" >{{ $user->name }}</a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left" aria-labelledby="zdropdownMenuButton">
                                            <a href="{{ route('site_manager.site_engineers.show', [ 'id' => $user->id ] ) }}" class="dropdown-item">
                                                {{__("View")}}
                                            </a>
                                            <a href="{{ route('site_manager.site_engineers.edit', [ 'id' => $user->id ] ) }}" class="dropdown-item">
                                                {{__("Edit")}}
                                            </a>
                                        </div>
                                    </div>
