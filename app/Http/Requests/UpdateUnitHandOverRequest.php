...
class UpdateUnitHandOverRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'appointment_image_url'     => 'mimes:pdf|max:10000',
            'handover_letter_image_url' => 'mimes:pdf|max:10000',
            'lor_image_url'             => 'mimes:pdf|max:10000',
