...
class ProjectUnitController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('site_manager.project.unit.index',  compact('units', 'statuses' ,'unit_types', 'zones', 'project'));
    }

    public function show(Request $request, $project_id, $unit_id)
    {
        // Check whether the requested $unit_id is in the managed project or not
