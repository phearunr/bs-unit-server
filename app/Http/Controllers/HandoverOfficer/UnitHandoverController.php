...
class UnitHandoverController extends Controller
{
    public function index(Request $request)
    {
        ...
        switch ($view) {
            case 'all':
                $handovers = UnitHandoverRequest::query()->where('user_id',Auth::user()->id);
                break;
        ...
        return view('handover_officer.unit_handover.index', compact('handovers', 'projects'));
    }
    ...
    public function create(Request $request, $id) 
    {
        ...
        if ($unit_handover_request AND $unit_handover_request->status == 'PENDING APPROVE') {
            // Show error 
            return Redirect::back()->withErrors(["The unit handover request for this unit had been created in PENDING APPROVE."]);
        }
       
        return view('handover_officer.unit_handover.new', compact('unit', 'users'));
    ...
    public function store(StoreUnitHandOverRequest $request)
    {
        ...
        try {          
            ...
            return redirect()->route('handover_officer.unit_handovers.edit', ['id'=>$handover->id])
    ...
    public function show($id)
    {
        ...
        return view('handover_officer.unit_handover.single', compact('unit_handover'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('handover_officer.unit_handover.edit', compact('handover', 'users' ,'approval_workflows'));
    }
    ...
    public function update(UpdateUnitHandOverRequest $request, $id)
    {
        ...
        try {          
            ...
            return redirect()->route('handover_officer.unit_handovers.edit',['id'=>$unit_handover->id])
    ...
    public function applyApprovalWorkflow(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('handover_officer.unit_handovers.index')
    ...
    public function import(Request $request)
    {
        ...
        try {     
            ...
            return redirect()->route('handover_officer.units.index')
