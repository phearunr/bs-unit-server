...
{    
    ...
    public function index(Request $request)
    {
		...
		return view('admin.site_engineer.index', compact('users','roles'));
    }
    ...
    public function create()
    {
		...
		return view('admin.site_engineer.new', compact('users','roles','projects'));
    }
	...
	{	
		try {
			...
			return redirect()
					->route('admin.site_engineers.edit', ['id' => $user->id])
    ...
    public function show(Request $request, $id) 
	{
		...
		return view('admin.site_engineer.single', compact('user'));
	}
    ...
    public function edit(Request $request, $id)
	{
		...
		$projects = Auth::user()->manageProjects->load('zones');
		return view('admin.site_engineer.edit', compact('user', 'projects'));
	}
	...
	{		
		...
		return redirect()
					->route('admin.site_engineers.edit', ['id' => $user->id, '#AccountSettingSection'])
	...
	public function updateManagedZone(UpdateSiteEngineerManagedZoneRequest $request, $id)
	{
		...
		return redirect()
						->route('admin.site_engineers.edit', ['id' => $user->id, '#ZoneManagementSection'])
	...
	public function showPasswordForm(Request $request, $id){
		...
		return view('admin.site_engineer.password_reset', compact('user'));
	}
