...
class UnitHandoverController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.unit_handover.index',compact('handovers','projects'));
    }
    ...
    public function create(Request $request,$id) 
    {
        ...
        return view('admin.unit_handover.new', compact('unit','users'));
    ...
    public function show($id)
    {
        ...
        return view('admin.unit_handover.single',compact('unit_handover'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.unit_handover.edit',compact('handover','users','approval_workflows'));
    }
    ...
    public function update(UpdateUnitHandOverRequest $request, $id)
    {
        ...
        try {          
            ...
            return redirect()->route('admin.unit_handovers.edit',['id'=>$unit_handover->id])
    ...
    public function applyApprovalWorkflow(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.unit_handovers.index')
